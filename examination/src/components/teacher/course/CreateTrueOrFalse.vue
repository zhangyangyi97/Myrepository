        ...
        <div id="form">
            ...
            >
                <el-form-item label="学科" prop="courseType">
                    <el-select v-model="trueorfalse.coursetype" placeholder="请选择学科">
                ...
                <el-form-item label="题型" prop="courseId" id="courseId">
                    <el-select v-model="trueorfalse.courseId=3" @change="changeHandle"
                               disabled
                               placeholder="请选择题型">
                ...
                <el-form-item label="标答" prop="answer">
                    ...
                    <el-radio-group v-model="trueorfalse.answer">
                ...
                <el-form-item label="分数" prop="point">
                    <el-input-number v-model="trueorfalse.point"
...
<script>
    export default {
        ...
        methods:{
            ...
            submitHandle(){
                this.trueorfalse.firstanw = '对'
                this.trueorfalse.secondanw = '错'
                this.$axios.post('course/trueorfalse',this.trueorfalse).then(resp=>{
            ...
            selectCtName(){
                this.$axios.get('course/selectCtName/'+this.trueorfalse.courseType).then(resp=>{
            ...
            resetAll(){
                this.trueorfalse.answer=''
                this.trueorfalse.coursetype=''
                this.trueorfalse.diff=''
                this.trueorfalse.point=''
                this.trueorfalse.title=''
                this.trueorfalse.secondanw=''
                this.trueorfalse.firstanw=''
                this.trueorfalse.courseId=''
            },
